...
class NotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tile' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-06-01 11:29:37',
            'modified' => '2017-06-01 11:29:37'
        ],
    ];
}
